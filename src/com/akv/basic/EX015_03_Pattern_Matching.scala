...
object EX015_03_Pattern_Matching extends App {
  ...
  println("Approach 2")
  println(aTypeMatch2("Amit"))
  println(aTypeMatch2(Map("Amit" -> "A", "Shubh" -> "S")))
  println(aTypeMatch2(List()))

  // Approach1 is preferred since patten matching encapsulate both isInstanceOf(Type Test)
  // and asInstanceOf(type Cast)
